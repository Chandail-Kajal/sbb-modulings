  ...
  return (
    <Section>
      <div className="flex flex-col items-center text-center font-sans max-w-5xl mx-auto px-4 py-8 section-container">
        ...
        {/* Subtext */}
        <p className="mt-6 text-sm sm:text-base text-neutral-600 max-w-2xl font-normal">
        ...
        <p className="mt-10 mb-8 sm:mb-12 text-sm sm:text-base font-bold text-neutral-900">
