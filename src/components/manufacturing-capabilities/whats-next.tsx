        ...
        <Section>
            <div className="w-full py-16 px-4 sm:px-8">
                <div className="max-w-6xl mx-auto">
                    {/* Main Banner Card */}
                    <div
                        className="relative w-full rounded-[2.25rem] overflow-hidden px-8 py-12 sm:px-14 sm:py-16 md:px-20 md:py-20 flex flex-col md:flex-row items-center justify-between gap-10 shadow-lg"
                        style={{
                            backgroundImage: "linear-gradient(115deg, #3b82f6 0%, #1e40af 100%)",
                        }}
                    >
                        {/* Subtle Monotone Noise Overlay */}
                        <div
                        ...
                        <div className="flex flex-col gap-4 max-w-xl z-10 text-white">
                            ...
                            <p className="text-xs sm:text-sm text-white/80 leading-relaxed max-w-md">
                                ...
                                capabilities designed to support demanding production requirements.
                            </p>
