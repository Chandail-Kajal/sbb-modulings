    ...
    <div>
        ...
        <div className="flex flex-col items-center text-center font-neue  section-container">
          ...
          <div className="mt-6 w-full space-y-4 text-fluid-18 text-neutral-600 font-normal leading-relaxed font-ce">
            <p>
              ...
              built for OEM and Tier-1 <br /> audit standards, not just to pass
              them.
            </p>
          </div>
      ...
      <Section >
        <div className="flex flex-col items-center text-center font-neue section-container">
          ...
          <div className="mt-6 w-full space-y-4 text-fluid-18 text-neutral-600 font-normal leading-snug font-ce">
            <p>
              ...
              chain.
              <br /> Our quality systems are built to make a vendor audit
